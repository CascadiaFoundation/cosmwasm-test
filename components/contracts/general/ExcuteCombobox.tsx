  ...
  return (
    ...
    >
      <div className="relative">
        <Combobox.Input
          className={clsx(
            'w-full bg-transparent border-2 border-dark/20 form-input',
        ...
        <Transition afterLeave={() => setSearch('')} as={Fragment}>
          ...
          >
            {filtered.length < 1 && (
              <span className="flex flex-col items-center justify-center p-4 text-sm text-center text-white/50">
