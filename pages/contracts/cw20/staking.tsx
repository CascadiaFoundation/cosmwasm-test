...
const CW20Staking = () => {
  ...
  const instantiate = async () => {
    try {
      ...
      const msg = {
        ...
        symbol: 'HORSE',
        decimals: 6,
        validator: 'cascadiadvaloper1xatlczsqz2vfwzxwv5try4pxprazveg4cyle50',
        unbonding_period: {
          height: 1000000,
        },
        // unbounding_period: {
  ...
  const query = async () => {
    try {
      const messages = contract?.use('cascadiad1q8y56lulqlkds83uvsh3cw044rspk42mem7mnnmdljgscv0vm5rqur4ss7')
      ...
      //   wallet.address,
      //   'cascadiad14wu56uyj9hw68x3mltxd2jl0298v4stg3qfcjt'
      // )
